function likelink(a, c, b) {
    ...
    document.getElementById(b + "likeimage" + a) && (document.getElementById(b + "likeimage" + a).setAttribute("src", "LIKEACTIVE"), document.getElementById(b + "like" + a).style.backgroundImage = "none");
    ...
    document.getElementById("likeimage" + a) && (document.getElementById("likeimage" + a).setAttribute("src", "http://i63.tinypic.com/2iu87x4.jpg"), document.getElementById("like" + a).style.backgroundImage = "none");
